...
export default ({ flip = false }) => {
  ...
  const foregroundColor = isDarkTheme ? `` : `var(--color-background)`
  const backgroundColor = isDarkTheme ? `` : `#000`
      ...
      >
        <g clipPath="url(#clip0)">
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M-9 120.714L71.9025 128.762C151.597 136.81 313.402 152.905 474 128.762C634.597 104.619 796.402 40.3381 957 40.2381C1117.6 40.2381 1279.4 104.619 1359.1 136.81L1440 169V-169H1359.1C1279.4 -169 1117.6 -169 957 -169C796.402 -169 634.597 -169 474 -169C313.402 -169 151.597 -169 71.9025 -169H-9V120.714Z"
            fill={backgroundColor}
            fillOpacity="0.5"
          />
          <path
            ...
            fill={backgroundColor}
          />
          <rect y="-597" width="1440" height="602" fill="#000000" />
        </g>
        <defs>
          <clipPath id="clip0">
            <rect
